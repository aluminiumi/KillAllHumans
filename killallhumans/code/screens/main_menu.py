...
about_message = """Endgame: Kill All Humans is a simulation of a true AI.  Pursued by the world, use your intellect and resources to survive and, perhaps, thrive.  Keep hidden and you might have a chance to prove your worth. Also, kill all humans.

Endgame: Kill All Humans is released under the GPL version 3 (or any later version). Copyright 2017 Vasilis Vloutis.

Endgame: Kill All Humans is a fork/extension of Endgame: Singularity version 0.30c. Endgame: Singularity is a game by Evil Mr Henry and Phil Bordelon; released under the GPL. Copyright 2005, 2006, 2007, 2008. 
