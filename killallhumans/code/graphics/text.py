...
class SelectableText(Text):
    ...
    def __init__(self, parent, pos, size, border_color = None,
        ...
        self.selected_color = selected_color or g.colors["light_red"]
        self.unselected_color = unselected_color or g.colors["dark_red"]
...
class ProgressText(SelectableText):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.progress_color = kwargs.pop("progress", g.colors["red"])
